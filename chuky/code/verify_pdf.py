...
# === 🔧 Cấu hình tệp tin (cập nhật đường dẫn theo môi trường của bạn) ===
...
ghi_log("=== HỆ THỐNG XÁC THỰC CHỮ KÝ PDF ===")
...
try:
    with open(DUONG_DAN_PDF, "rb") as tep_pdf:
        ...
        if muc_do == ModificationLevel.NONE:
            ...
            ghi_log("⚠️ Có chỉnh sửa nhẹ (biểu mẫu) sau khi ký.")
        else:
...
ghi_log("\n📘 Quá trình kiểm tra hoàn tất – kết quả được lưu trong result_log.txt.")
ghi_log("👨‍💻 Người thực hiện: Hau Thanh Huyen")
ghi_log("===============================================")